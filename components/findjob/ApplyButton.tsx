                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="grid gap-4 sm:grid-cols-2 sm:gap-6 px-10 py-10">
                                        <div className="sm:col-span-2">
                                            ...
                                            <p className='text-xs font-light pb-2 text-gray-600 dark:text-gray-200'>Дайте повече информация за себе си, за да може да ви наемат. Споделете всичко, което смятате за важно и което ви отличава от другите кандидати. <strong>Биото е еднакво за всичките ви кандидатури, промените ли го, то ще бъде променено в тях!</strong></p>
                                        ...
                                        <div className="w-full">
                                            ...
                                            <p className='text-xs font-light pb-2 text-gray-600 dark:text-gray-200'>Въведете цената, за която бихте извършили услугата. За избраната услуга изпълнителят е задал максимална цена {maxprice} лв. Имате право да предложите и по-висока цена, но най-вероятно кандидатурата ви няма да бъде разгледана!</p>
