...
const Page: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Check if maxprice is a valid number greater than 0
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div className="w-full">
                                ...
                                <p className='text-xs font-light pb-2 text-gray-600'>Изберете град, в който искате да се извърши услугата (за момента е възможно само в София)</p>
                                <select
                                    name="location"
                                    id="location"
